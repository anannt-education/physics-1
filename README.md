...
- Course map for all eight official units (Units 2–8 labelled unpublished / waitlist)
...
Open [http://127.0.0.1:43141/physics-1](http://127.0.0.1:43141/physics-1). The dev script binds `0.0.0.0:43141`. Production URLs are `https://study.anannt.ae/physics-1`. Set `SITE_URL=https://study.anannt.ae`.

Public: subject home, exam guide (`/about`), legal, course map, two Unit 1 lessons, diagnostic start, graph-repair paths. Units 2–8 are unpublished waitlist cards. Mocks, FRQ, and practice are gated.
